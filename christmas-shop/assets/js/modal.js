...
[elements.category, elements.name, elements.description] =
  document.querySelectorAll(".modal-info > *");
[
  elements.superpowers.live,
  elements.superpowers.create,
  elements.superpowers.love,
  elements.superpowers.dream,
] = document.querySelectorAll(".superpowers-grade");
[
  elements.starsList.live,
  elements.starsList.create,
  elements.starsList.love,
  elements.starsList.dream,
] = document.querySelectorAll(".stars-list");
